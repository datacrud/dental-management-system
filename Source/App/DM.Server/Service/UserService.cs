...
namespace DM.AuthServer.Service
{
    public interface IUserService : IBaseService<ApplicationUser>
    {
        ...
        Task<IdentityResult> CreateUser(Models.RequestModels.UserCreateRequestModel model);        
        Task<IdentityResult> UpdateUser(Models.RequestModels.UserCreateRequestModel model);
...
//User Section
        ...
        public Task<IdentityResult> CreateUser(Models.RequestModels.UserCreateRequestModel model)
        {
        ...
        public Task<IdentityResult> UpdateUser(Models.RequestModels.UserCreateRequestModel model)
        {            
