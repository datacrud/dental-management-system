...
namespace DM.AuthServer.Repository
{
    ...
    {               
        SecurityModels.Permission CheckPermission(Models.RequestModels.PermissionRequestModel model);
    ...
    public class PermissionRepository : BaseRepository<SecurityModels.Permission>, IPermissionRepository
    {
        ...
        public SecurityModels.Permission CheckPermission(Models.RequestModels.PermissionRequestModel model)
        {
